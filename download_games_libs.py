...
download_options = [
    ...
    ['Sony PlayStation (1-G)', 'https://archive.org/download/SonyPlayStationSpecialCollectionSingleDiscGames1G'],
    ['Sony PlayStation (H-P)', 'https://archive.org/download/SonyPlayStationSpecialCollectionSingleDiscGamesHP'],
    ['Sony PlayStation (Q-Z)', 'https://archive.org/download/SonyPlayStationSpecialCollectionSingleDiscGamesQZ' ],
